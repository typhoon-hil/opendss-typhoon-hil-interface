def update_properties(mdl, _Line_mask):
    ...
    """
    mdl.set_handler_code(_Line_mask_input_type, "property_value_changed",
                         _Line_mask_input_type_property_value_changed)
    ...
    comp_script.port_dynamics(mdl, container_handle, caller_prop_handle=prop_handle)
    """
    mdl.set_handler_code(_Line_mask_dC1, "property_value_changed",
                         _Line_mask_dC1_property_value_changed)
    ...
    comp_script.port_dynamics(mdl, container_handle, caller_prop_handle=prop_handle)
    """
    mdl.set_handler_code(_Line_mask_coupling, "property_value_changed",
                         _Line_mask_coupling_property_value_changed)
