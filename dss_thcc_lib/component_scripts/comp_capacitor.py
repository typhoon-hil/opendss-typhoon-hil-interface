...
def define_icon(mdl, mask_handle):
    ...
    filenames = {"1": {"In series": "cap_1S",
                       "Y - Grounded": "cap_1Y_g",
                       "Y - Neutral point accessible": "cap_1Y_n",
                       "Δ": "cap_1Y_n"},
                 "2": {"In series": "cap_2S"},
                 "3": {"In series": "cap_3S",
                       "Y - Grounded": "cap_3Y_g",
    ...
    if sld_mode in (True, "True"):
        if phases == "3":
            if tp_connection == "Δ":
                mdl.disp_component_icon_text(mask_handle, "ABC", rotate="rotate", relpos_x=0.57, relpos_y=0.5,
                                             size=8, trim_factor=2)
                mdl.disp_component_icon_text(mask_handle, "Δ", rotate="rotate", relpos_x=0.25, relpos_y=0.15,
                                             size=8, trim_factor=2)
            ...
            if tp_connection == "In series":
                ...
                mdl.disp_component_icon_text(mask_handle, sld_text, rotate="rotate", relpos_x=0.7, relpos_y=0.5,
                                             size=8, trim_factor=2)
...
def retro_compatibility(mdl, container_handle):
    map_dict = {"Y": "Y - Neutral point accessible",
                "Y-grounded": "Y - Grounded",
                "Series": "In series"}
