...
class Ui_objects(object):
    ...
    def setupUi(self, objects):
        ...
        self.edit_interval_tshape.setGeometry(QtCore.QRect(50, 75, 51, 20))
        ...
        self.combo_interval_tshape = QtWidgets.QComboBox(self.group_tshape_parameters)
        self.combo_interval_tshape.setGeometry(QtCore.QRect(105, 75, 41, 20))
        self.combo_interval_tshape.setObjectName("combo_interval")
        self.combo_interval_tshape.addItem("")
    ...
    def retranslateUi(self, objects):
        ...
        self.combo_interval_tshape.setItemText(0, _translate("objects", "h"))
