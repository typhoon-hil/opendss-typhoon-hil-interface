...
def update_neutrals(mdl, mask_handle, T_handle):
...
def update_subsystem_components(mdl, mask_handle):
    ...
    update_neutrals(mdl, mask_handle, T_handle)
...
def update_winding_configs(mdl, prop_handle, mask_handle):
    ...
    update_neutrals(mdl, mask_handle, T_inner)

    mdl.refresh_icon(mask_handle)


def update_all_windings(mdl, mask_handle):
