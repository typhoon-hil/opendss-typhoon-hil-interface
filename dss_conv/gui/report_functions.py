...
def generate_report(filename):
    ...
    class NumberedCanvas(canvas.Canvas):
        ...
        def footer(self):
            ...
            conv_path = os.getenv("TYPHOON_OPENDSS_INTERFACE")
            self.drawImage(os.path.join(conv_path, "libs/images/elephant.png"), 60, 2, 0.05 * 843,
                           0.05 * 478)
            self.drawImage(os.path.join(conv_path, "libs/images/opendss.jpg"), pg_w - 210, 0, 0.1 * 400, 0.1 * 291)
