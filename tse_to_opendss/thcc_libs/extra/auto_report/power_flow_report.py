...
from tse_to_opendss.thcc_libs.extra.auto_report.report_functions import *
...
def generate_report(mdlfile):
    ...
    try:
        ...
        doc = SimpleDocTemplate(f'{target_files_folder}/dss/reports/{filename}_powerflow_report.pdf',
