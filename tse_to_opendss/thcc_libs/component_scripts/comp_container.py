...
def pick_contained_comp_calls(mdl, mask_handle):
    ...
    if identifier == "Load":
        import container.load_container as contained_comp_calls
    elif identifier == "Vsource":
        import container.vsource_container as contained_comp_calls
    elif identifier == "Line":
        import container.line_container as contained_comp_calls
    elif identifier == "Capacitor Bank":
        import container.capacitor_bank_container as contained_comp_calls
    elif identifier == "Controlled Switch":
        import container.controlled_switch_container as contained_comp_calls
    elif identifier == "Fault":
        import container.fault_container as contained_comp_calls
    elif identifier == "Isource":
        import container.isource_container as contained_comp_calls
    elif identifier == "Three-Phase Transformer":
        import container.three_phase_transformer_container as contained_comp_calls
    elif identifier == "Single-Phase Transformer":
        import container.single_phase_transformer_container as contained_comp_calls
    elif identifier == "Generator":
        import container.generator_container as contained_comp_calls
    elif identifier == "Storage":
        import container.storage_container as contained_comp_calls
    elif identifier == "VSConverter":
        import container.vsconverter_container as contained_comp_calls
