...
def define_icon(mdl, mask_handle):
    ...
    if model_path_plib.is_file():
        ...
        mdl.disp_component_icon_text(mask_handle, model_path_plib.stem + ".dss", relpos_x=0.5, relpos_y=0.5, size=8)
    else:
        mdl.set_color(mask_handle, "red")
        mdl.disp_component_icon_text(mask_handle, "Select a model", relpos_x=0.5, relpos_y=0.5, size=8)